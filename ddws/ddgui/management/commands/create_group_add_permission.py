""" This comannd creates group and adds permissions to the new group for to User model """
#for groups list refer to ddws/hardcode.py - look at specific group 
# syntax:   python3 manage.py create_group_add_permission -g promo --permission can_hoax --text "Can hoax" 
#           python3 manage.py create_group_add_permission -g spoof -p can_spoof -t "Can spoof"
#           python3 manage.py create_group_add_permission -g recieve_news -p can_recievenews -t "Will recieve site news"
